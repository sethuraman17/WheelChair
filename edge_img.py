...
# (190, 420) (410, 225) (610, 420) = test_image
# (0, 420), (330, 0), (680, 420) = test_image2
mask = np.zeros_like(canny_img)

# height = img.shape[0]       # 420
# width = img.shape[1]        # 680
# roi_img = np.array([[(190, 420), (410, 225), (610, 420)]], np.int32)
roi_img = np.array([[(0, 420), (330, 0), (680, 420)]], np.int32)
